...
import { Constant, ISlideInUpContainerProps, SlideInUpPresentation } from '.';

export const SlideInUp: React.FC<ISlideInUpContainerProps> = ({
  children,
  ...
  return (
    <SlideInUpPresentation containerStyle={animatedStyle}>
      {children}
    </SlideInUpPresentation>
  );
};
